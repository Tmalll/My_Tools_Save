...
echo "设置IP地址和网络掩码。"
netsh interface ip set address "物理网络" source=static addr=192.168.1.120 mask=255.255.255.0

netsh interface ip set address "虚拟内网" source=static addr=192.168.88.120 mask=255.255.255.0
