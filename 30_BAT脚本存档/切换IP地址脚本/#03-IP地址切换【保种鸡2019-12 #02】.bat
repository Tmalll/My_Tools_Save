...
echo "设置IP地址和网络掩码。"
netsh interface ip set address "物理网络" source=static addr=192.168.1.81 mask=255.255.255.0
netsh interface ip set address "虚拟内网1" source=static addr=192.168.88.81 mask=255.255.255.0
