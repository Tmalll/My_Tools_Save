...
treasureclassex.rows.forEach((row) => {
  ...
  switch (config.disdrop_junk) {
    ...
    case 'dis_junk1':
      ModItem4(row, 'Act 1 Junk', 'Potion 1', 8, 'Ammo', 2, '', '', '', '');
      ModItem4(row, 'Act 2 Junk', 'Act 1 Junk', 2, 'Potion 2', 8, 'Ammo', 2, '', '');
      ModItem4(row, 'Act 3 Junk', 'Act 2 Junk', 2, 'Potion 3', 8, 'Ammo', 2, '', '');
      ModItem4(row, 'Act 4 Junk', 'Act 3 Junk', 2, 'Potion 4', 8, 'Ammo', 2, '', '');
      ModItem4(row, 'Act 5 Junk', 'Act 4 Junk', 2, 'Potion 5', 8, 'Ammo', 2, '', '');
      ModItem4(row, 'Act 1 (N) Junk', 'Act 5 Junk', 2, 'Potion 6', 8, 'Ammo', 2, '', '');
      ModItem4(row, 'Act 2 (N) Junk', 'Act 5 Junk', 2, 'Potion 6', 8, 'Ammo', 2, '', '');
      ModItem4(row, 'Act 3 (N) Junk', 'Act 5 Junk', 2, 'Potion 6', 8, 'Ammo', 2, '', '');
      ModItem4(row, 'Act 4 (N) Junk', 'Act 5 Junk', 2, 'Potion 6', 8, 'Ammo', 2, '', '');
      ModItem4(row, 'Act 5 (N) Junk', 'Act 5 Junk', 2, 'Potion 6', 8, 'Ammo', 2, '', '');
      ModItem4(row, 'Act 1 (H) Junk', 'Act 5 Junk', 2, 'Potion 6', 8, 'Ammo', 2, '', '');
      ModItem4(row, 'Act 2 (H) Junk', 'Act 5 Junk', 2, 'Potion 6', 8, 'Ammo', 2, '', '');
      ModItem4(row, 'Act 3 (H) Junk', 'Act 5 Junk', 2, 'Potion 6', 8, 'Ammo', 2, '', '');
      ModItem4(row, 'Act 4 (H) Junk', 'Act 5 Junk', 2, 'Potion 6', 8, 'Ammo', 2, '', '');
      ModItem4(row, 'Act 5 (H) Junk', 'Act 5 Junk', 2, 'Potion 6', 8, 'Ammo', 2, '', '');
      ModMagic(row);
      break;
    // 禁止掉宝箱钥匙, 卷轴, 爆炸, 毒气, 箭袋
    case 'dis_junk2':
