...
show_help() {
    echo -e "${GREEN}Base64 自动化处理工具 (v9.2)${NC}"
...
# C. 单文件/手动模式
    ...
    # 单文件依然输出到文件所在目录下的 output (或者保持原位，看你习惯)
    # 这里为了保持一致性，建议也输出到 ./output
