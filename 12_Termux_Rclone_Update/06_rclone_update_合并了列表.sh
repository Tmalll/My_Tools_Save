...
task_list=(
    ...
    # 备份到: 下载机E盘
    "sync,local:/storage/emulated/0/backups,SMB-120:/E/#14-Rclone-BAK/backups-Note12/#latest, \
    ...
    # 备份到: Home-WebDAV
    "sync,local:/storage/emulated/0/backups,Home-WebDAV-BAK:/backups-Note12/#latest, \
    ...
    # Termux 核心脚本与配置备份
    "sync,/data/data/com.termux,SMB-120:/E/Termux_Backup/#latest, \
