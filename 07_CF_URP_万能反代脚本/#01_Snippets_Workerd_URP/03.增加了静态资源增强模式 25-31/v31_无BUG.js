...
<head>
    ...
    <style>
        body{font-family:-apple-system,sans-serif;max-width:780px;margin:40px auto;padding:0 20px;color:#333;line-height:1.6}
        .box{margin-bottom:25px;background:#f9f9f9;padding:18px;border-radius:6px;border:1px solid #ddd}
        .title{font-weight:bold;font-size:15px;color:#111;margin-bottom:5px}
        .form{display:flex;margin:12px 0}
        input{flex:1;padding:10px;font-size:14px;border:1px solid #ccc;border-radius:4px 0 0 4px;outline:none}
        button.btn-go{padding:10px 20px;background:#0076ff;color:#fff;border:none;border-radius:0 4px 4px 0;cursor:pointer;font-weight:bold}
        .sample-title{font-size:13px;font-weight:bold;color:#444;margin-top:12px;margin-bottom:6px}
        .sample-item{display:flex;align-items:center;justify-content:between;background:#f1f1f1;padding:8px 12px;border-radius:4px;margin-bottom:8px;font-size:13px}
        .sample-item a{color:#0076ff;text-decoration:none;word-break:break-all;flex:1;margin-right:10px}
        .sample-item a:hover{text-decoration:underline}
        .btn-copy{padding:4px 10px;background:#fff;color:#333;border:1px solid #ccc;border-radius:4px;cursor:pointer;font-size:12px;white-space:nowrap;user-select:none}
...
<body>
    ...
    <div class="box">
        ...
        <div class="sample-title">拼接示例:</div>
        <div class="sample-item">
            <a href="${prefixNormal}/https://github.com/2dust/v2rayN" target="_blank" class="link-url">${prefixNormal}/https://github.com/2dust/v2rayN</a>
            <button type="button" class="btn-copy" onclick="copyLink(this)">复制链接</button>
        </div>
        <div class="sample-item">
            <a href="${prefixNormal}/https/github.com/2dust/v2rayN" target="_blank" class="link-url">${prefixNormal}/https/github.com/2dust/v2rayN</a>
            <button type="button" class="btn-copy" onclick="copyLink(this)">复制链接</button>
    ...
    <div class="box">
        <div class="title">静态内容增强模式 (修正标头):</div>
        ...
        <div class="sample-title">拼接示例:</div>
        <div class="sample-item">
            <a href="${prefixStatic}/https://gist.githubusercontent.com/Tmalll/74f08eaff7dfdb21f547a71af2596498/raw/7.10.html" target="_blank" class="link-url">${prefixStatic}/https://gist.githubusercontent.com/Tmalll/74f08eaff7dfdb21f547a71af2596498/raw/7.10.html</a>
            <button type="button" class="btn-copy" onclick="copyLink(this)">复制链接</button>
        </div>
        <div class="sample-item">
            <a href="${prefixStatic}/https/gist.githubusercontent.com/Tmalll/74f08eaff7dfdb21f547a71af2596498/raw/7.10.html" target="_blank" class="link-url">${prefixStatic}/https/gist.githubusercontent.com/Tmalll/74f08eaff7dfdb21f547a71af2596498/raw/7.10.html</a>
    ...
    <script>
        ...
        function copyLink(btn) {
            const linkText = btn.parentNode.querySelector('.link-url').innerText;
