...
<head>
    ...
    <style>
        ...
        .sample-box a{color:#0288d1;text-decoration:none}
...
<body>
    ...
    <div class="section">
        ...
        <div class="sample-box"><a href="${prefixNormal}/https://github.com/2dust/v2rayN" target="_blank">${prefixNormal}/https://github.com/2dust/v2rayN</a>
<a href="${prefixNormal}/https/github.com/2dust/v2rayN" target="_blank">${prefixNormal}/https/github.com/2dust/v2rayN</a></div>
    </div>
    ...
    <div class="section">
        ...
        <div class="title" style="font-size:13px;margin-bottom:5px;">拼接示例:</div>
        <div class="sample-box"><a href="${prefixStatic}/https://gist.githubusercontent.com/Tmalll/74f08eaff7dfdb21f547a71af2596498/raw/7.10.html" target="_blank">${prefixStatic}/https://gist.githubusercontent.com/Tmalll/74f08eaff7dfdb21f547a71af2596498/raw/7.10.html</a>
<a href="${prefixStatic}/https/gist.githubusercontent.com/Tmalll/74f08eaff7dfdb21f547a71af2596498/raw/7.10.html" target="_blank">${prefixStatic}/https/gist.githubusercontent.com/Tmalll/74f08eaff7dfdb21f547a71af2596498/raw/7.10.html</a></div>
    </div>
