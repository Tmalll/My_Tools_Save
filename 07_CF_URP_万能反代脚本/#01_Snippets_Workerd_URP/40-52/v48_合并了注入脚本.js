...
const CONFIG = {
    ...
    ROUTE_REGISTRY: {
        'normal': { path: '', mime: 'ORIGIN', rewrite: true, ttl: 1800, max_size: 15360, rewrite_no_len: true, isMain: true, name: '普通 (RAW)' },
        'static': { path: 'static', mime: 'AUTO_MAP', rewrite: true, ttl: 86400, max_size: 10240, rewrite_no_len: false, isMain: true, name: 'Static 覆写' },
        'static_no_rewrite': { path: 'static_no_rewrite', mime: 'AUTO_MAP', rewrite: false, ttl: 604800, max_size: 0, rewrite_no_len: false, isMain: true, name: 'Static 长缓存' },
        'is-doh': { path: 'is-doh', mime: 'ORIGIN', rewrite: false, ttl: 300, max_size: 0, rewrite_no_len: false, isMain: true, name: '强制 DOH 反代' },
        
        // 强制 MIME 模式扩展 (max_size 和 rewrite_no_len 均可在下方独立精细微调)
        'is-html': { path: 'is-html', mime: 'text/html', rewrite: true, ttl: 86400, max_size: 15360, rewrite_no_len: true },
        'is-md': { path: 'is-md', mime: 'text/markdown', rewrite: false, ttl: 604800, max_size: 0, rewrite_no_len: false },
        'is-markdown': { path: 'is-markdown', mime: 'text/markdown', rewrite: false, ttl: 604800, max_size: 0, rewrite_no_len: false },
        'is-css': { path: 'is-css', mime: 'text/css', rewrite: false, ttl: 604800, max_size: 0, rewrite_no_len: false },
        'is-js': { path: 'is-js', mime: 'application/javascript', rewrite: false, ttl: 604800, max_size: 0, rewrite_no_len: false },
        'is-json': { path: 'is-json', mime: 'application/json', rewrite: false, ttl: 86400, max_size: 0, rewrite_no_len: false },
        'is-txt': { path: 'is-txt', mime: 'text/plain', rewrite: false, ttl: 86400, max_size: 0, rewrite_no_len: false },
        'is-xml': { path: 'is-xml', mime: 'text/xml', rewrite: false, ttl: 86400, max_size: 0, rewrite_no_len: false },
        'is-csv': { path: 'is-csv', mime: 'text/csv', rewrite: false, ttl: 86400, max_size: 0, rewrite_no_len: false }
    }
};
...
export default {
    async fetch(request, env, ctx) {
        ...
        // 🟢 智能边界清洗修复：同时完美支持 https/ 和带有 :// 的手动拼接
        ...
        // 全局针对特定 AJAX 请求补充标头（对跨域切换路由的 SPA 应用更友好）
        ...
        if (shouldRewrite) {
            try {
                ...
                // 🟢 全局融合后的通用异步注入拦截脚本（已取消 github_fix 分支判断，全局泛化应用）
