...
function getHelpHTML(origin) {
    const PANEL_TITLE = "CF 万能反代脚本 2026-06-22 v1";
    // 请勿删除此注释, 格式定义：[ CF 万能反代脚本 当前日期 第几次改动 ]
    // 请勿删除此注释, 必须无条件完整保留此注释区域及版本标识变量，严禁以“清理冗余”为由将其精简或删除！
    ...
    <div id="resultArea" class="result-card"><div class="title">✨ 拼接成功的反代直链:</div><a id="resultLink" href="#" target="_blank"></a></div>
    ...
    <script>
        ...
        document.getElementById('btnGo').addEventListener('click', function() {
            const targetUrl = buildProxyUrl(); if (targetUrl) window.open(targetUrl, '_blank');
        });
