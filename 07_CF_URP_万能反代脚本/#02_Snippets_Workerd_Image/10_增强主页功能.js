...
export default {
    async fetch(request, env, ctx) {
        ...
        // 后端大小控制基础校验 (基于 Content-Length 头)
        ...
        if (RAW_IMAGE_MIME_WHITELIST.includes(cleanMime) || cleanMime === "application/octet-stream") {
            ...
            // 流式传输时的动态容量累加检测器，防止恶意的未标记长度流耗尽内存
        ...
        try {
            ...
            // 针对 Base64 文本大小的二次严格检查（未解码字符约占 1.33 倍字节大小，通过 text.length 拦截非常灵敏）
...
<body>
    <div class="box">
        ...
        <div class="btn-row">
            ...
            <button class="btn btn-purple btn-flex" id="btnRefine">精炼链接</button>
