...
:: ====== 输出文件名 ======
set "OutputFile=[%ExtensionName%][Chrome-Store][%ExtensionID%].crx"
...
:: ====== 开始下载 ======
curl -L -o "%OutputFile%" "%webProxy%%CRX_URL%" --resolve cfproxy.miaosky.top:443:%bestIP% -v -A "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/%ChromeVersion% Safari/537.36"
