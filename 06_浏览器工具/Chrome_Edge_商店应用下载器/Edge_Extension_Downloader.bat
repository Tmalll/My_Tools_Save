...
curl -L -o "%~dp0\[%ExtensionName%][Edge-Store][%ExtensionID%].crx" "https://edge.microsoft.com/extensionwebstorebase/v1/crx?x=id%%3D%ExtensionID%%%26installsource%%3Dondemand&response=redirect" -A "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36 Edg/143.0.0.0" -vv
